...
<html lang="en">
    ...
    <body>
            ...
            <ul class="nav" type="none">
                <li>
                    <ul class="nav1" type="none">
                        <li><h1><a href="home.html"><img src="Logo.png" height="100px;" width="100px;"></a></h1></li> 
                    </ul> 
                </li>       
                <li>
                    <ul class="nav2" type="none">
                        ...
                        <li><a href="myappointment.php"><input type="button" class="appointment" value="My Appointments"></a></li>
                    </ul>
                </li>    
            </ul>
        </nav>
        ...
        <div class="flex">
            <h1 align="center">HERE IS FLEX</h1>
        </div>
